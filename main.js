...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var account, choice, _a, depositAmount, withdrawAmount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3: return [4 /*yield*/, inquirer_1.default.prompt({
                        ...
                        validate: function (input) { return input > 0 ? true : 'Please enter a positive number.'; }
                    })];
                case 4:
                    depositAmount = (_b.sent()).depositAmount;
                ...
                case 6:
                    withdrawAmount = (_b.sent()).withdrawAmount;
